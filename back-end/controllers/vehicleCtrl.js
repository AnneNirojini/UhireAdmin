...
const vehicleCtrl = {
    ...
    createVehicle: async (req, res) => {
        try {
            const { vehicle_id, vehicleType, ServiceType, model, images, name, eMail, contactNumber, address } = req.body;
            ...
            const newVehicle = new Vehicles({
                vehicle_id, vehicleType, ServiceType, model, images, name, eMail, contactNumber, address
            })
